						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">NOTE:Admin should make sure that all the fields are edited.</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Kilometer(in Baht)<span style="color:red">*</span></label>
<div class="col-sm-4">
