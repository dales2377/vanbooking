...
//echo $fromdate, $todate, $destination , $startLocation , $message;

$useremail=$_SESSION['login'];
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,startLocation,destination,message,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:startLocation,:destination,:message,:status)";
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>฿<?php echo htmlentities($result->PricePerDay);?> </p>Km
            ...
            <!-- Edited Form-->
              <form method="post">
                  ...
                  <div class="form-group">
                      ...
                      <input type="datetime-local" class="form-control" name="fromdate" placeholder="from">
                  </div>
                  ...
                  <div class="form-group">
                      <label for="startpoint">Choose Your Location</label><br>
                          <select class="form-control"  name="startlocation" required>
                              <option selected>Select--</option>
                              <option value="elijah">Elijah Hall</option>
                              <option value="solomon">Solomon Hall</option>
                              <option value="sarah">Sarah Hall</option>
                              <option value="esther">Esther Hall</option>
                              <option value="Eve">Eve Hall</option>
                              <option value="sarah">Sarah Hall</option>
                              <option value="ruth">Ruth Hall</option>
                          </select>
                  </div>
                  ...
                  <select class="form-control" name="destination" required>
                      <option selected>Select--</option>
                      <option value="mochit">Mochit BTS Station</option>
                      <option value="suvarnabhumi">Suvarnabhumi Airport</option>
                      <option value="DonMueang">Don Mueang Airport</option>
                  </select>
                  </div>
                    <hr>
                  <label for="message">Booking Notes</label>
                  <div class="form-group">
                      <textarea rows="3" class="form-control" name="message" placeholder="notes..."></textarea>
                  </div>
